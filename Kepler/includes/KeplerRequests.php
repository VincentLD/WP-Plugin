...
class KeplerRequest {
    ...
    if (is_null(self::$instance)) {
        ...
        self::$instance = new KeplerRequest();
    }

    return self::$instance;
    }

    public static function kepler_get_vehicles(string $endpoint = 'vehicles/', string $api_version = self::KEPLER_VERSION_VEHICLES) {
